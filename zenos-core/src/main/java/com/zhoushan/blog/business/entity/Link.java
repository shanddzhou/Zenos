...
import com.zhoushan.blog.business.enums.LinkSourceEnum;
...
public class Link {
    ...
    @Length(max = 15, min = 1, message = "站点名称建议保持在15个字符以内")
    ...
    @Length(max = 30, min = 1, message = "站点描述不要太长哟~~")
    public String getDescription() {
        return this.sysLink.getDescription();
    }

    public void setDescriptioin(String descriptioin) {
        this.sysLink.setDescription(descriptioin);
    }
